...
typedef struct
{
  ...
  real32_T     init_Kd;
  real32_T     init_Kn;
  real32_T     init_OutUpLim;
  real32_T     init_OutLoLim;
  real32_T     init_OutRateLim;


  T_pid_state  PID_state;
  real32_T     smpl_time;
}
PIDParams;
...
typedef struct
{
  ...
  real32_T     scale_Kd;
  real32_T     scale_Kn;
  real32_T     scale_OutUpLim;
  real32_T     scale_OutLoLim;
  real32_T     scale_OutRateLim;
}
PIDParams_scale;
