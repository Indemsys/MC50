  ...
  #define   PWM_STEP_COUNT              2000           // Количество ступеней в генераторе PWM сигнала мотора
  ...
  // Макросы ограничения минимальной длительности импульсов ШИМ
  #define   MIN_PWM_PULSE_nS            7000ll          // Минимальная длительность импульса ШИМ в наносекундах
  #define   MIN_PWM_COMPARE_VAL         ((MIN_PWM_PULSE_nS*PCLKD_FREQ)/2000000000ll)

  // Макросы установки мертвого времени
  ...
  // Частота сэмплирования ручного энкодера на плате для пользовательского управления в Гц
  #define   MAN_ENC_SAMLE_RATE          10000ul


  // Макросы со значениями частот на системных шинах
...
extern void Delay_m7(int cnt); // Задержка на (cnt+1)*7 тактов . Передача нуля не допускается
  ...
  #include "Pins.h"
  #include "PWM_3Ph_OPS.h"
  #include "PWM_Triangle_3Ph_buffered.h"
  #include "PWM_Triangle_3Ph_2buffered.h"
  #include "Rot_Encoders_capturing.h"
  #include "SPI0.h"
  #include "DAC.h"
  #include "AGT.h"
  #include "ADC.h"
  ...
  #include "Speed_PID.h"
  #include "CSVPWM_gen.h"
  #include "Sin_gen_3Ph.h"
  #include "Motor_OPS_BLDC_control.h"
  #include "Servo_OPS_BLDC_control.h"
  #include "Servo_BLDC_control.h"
  #include "Motor_BLDC_control.h"
  #include "Async_Sinusoidal_rotation.h"
  #include "BLDC_mot_test.h"
  #include "CommutationLaw_search.h"
