...
#define   TEST_FLAG                                BIT(18)
#define   SINUSOIDAL_ROT_ON                        BIT(19)
#define   COMMUTATION_LAW_SEARCH                   BIT(20)
#define   BLDC_ROT_CW                              BIT(21)
#define   BLDC_ROT_CCW                             BIT(22)

#define   MC_SPEED_LOOP_TICK                       BIT(31)

#define   OUT_NO_ACTION                            0
#define   OUT_TO_ENABLE                            1
#define   OUT_TO_DISABLE                           2
