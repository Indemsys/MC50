...
typedef struct
{
  ...
  float          min_rotation_speed;            // Minimal rotation speed (grad per sec) | def.val.= 3
  ...
  float          rotation_speed;                // Nominal rotation speed (grad per sec) | def.val.= 25
