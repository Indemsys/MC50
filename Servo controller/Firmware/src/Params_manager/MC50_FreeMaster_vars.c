...
FMSTR_TSA_RW_VAR( wvar.min_rotation_speed              ,FMSTR_TSA_FLOAT     ) // Minimal rotation speed (grad per sec) | def.val.= 3
...
FMSTR_TSA_RW_VAR( wvar.rotation_speed                  ,FMSTR_TSA_FLOAT     ) // Nominal rotation speed (grad per sec) | def.val.= 25
