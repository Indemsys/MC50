...
UINT  ux_hcd_synergy_request_bulk_transfer(UX_HCD_SYNERGY *hcd_synergy, UX_TRANSFER *transfer_request)
{
    ...
    //if (transfer_request->ux_transfer_request_type == 0)
    //{
    //   //ITM_EVENT32(1, transfer_request->ux_transfer_request_requested_length);
    //}
...
//       else
//       {
//           ITM_EVENT32(2, (uint32_t)data_td->ux_synergy_td_buffer);
//       }
//    }
...
//       else
//       {
//           ITM_EVENT32(3, (uint32_t)tail_td->ux_synergy_td_buffer);
//       }
//    }
