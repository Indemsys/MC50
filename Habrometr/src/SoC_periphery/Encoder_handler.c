...
#define ENC_SCAN_PERIOD_US           (1000000ul/INT_ADC_SMPL_RATE_HZ)  // Периодиченость вызова функции обработки сигналов энкодера
#define TIMEOUT_MAX_LONG_PRESSING    ((10*1000000)/ENC_SCAN_PERIOD_US) // 10 сек  - прололжительность максимально длинного нажати
#define TIMEOUT_LONG_PRESSING        ((2*1000000)/ENC_SCAN_PERIOD_US)  // 1  сек  - продолжительность длинного нажати
