...
typedef struct WINDOW_HABROMETR_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PROMPT window_habrometr_Val_user;
    GX_PROMPT window_habrometr_Lb1;
    GX_PROMPT window_habrometr_Lb2;
    GX_PROMPT window_habrometr_Lb3;
    GX_PROMPT window_habrometr_Lb4;
    GX_PROMPT window_habrometr_Lb5;
    GX_PROMPT window_habrometr_Val_voices;
    GX_PROMPT window_habrometr_Val_views;
    GX_PROMPT window_habrometr_Val_subscraibers;
    GX_PROMPT window_habrometr_Val_rating;
    GX_PROMPT window_habrometr_Val_karma;
    GX_PROMPT window_habrometr_Val_date_time;
} WINDOW_HABROMETR_CONTROL_BLOCK;

typedef struct WINDOW_MENU_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PROMPT window_menu_sdcard_state;
    GX_PROMPT window_menu_network_state;
    GX_PROMPT window_menu_version;
    GX_PROMPT window_menu_habrometer;
...
typedef struct WINDOW_NET_STATE_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window_net_state_Lb1;
    GX_PROMPT window_net_state_Lb2;
    GX_PROMPT window_net_state_Val_PID;
    GX_PROMPT window_net_state_Val_MAC;
    GX_PROMPT window_net_state_Lb3;
    ...
    GX_PROMPT window_net_state_Lb4;
    GX_PROMPT window_net_state_Lb5;
    GX_PROMPT window_net_state_Lb6;
...
extern WINDOW_HABROMETR_CONTROL_BLOCK window_habrometr;
...
UINT Habrometer_event_callback(GX_WINDOW *widget, GX_EVENT *event_ptr);
VOID Habrometer_draw_callback(GX_WINDOW *widget);
