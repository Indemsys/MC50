...
const T_IO_pins_configuration MC50_pins_cfg[] =
{
  ...
  {"P208",&R_PFS->P208PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "VL           " },  //     37   P208  DEBUG_TRACE0_TDATA3/ETH_MII0_LINKSTA/ETH_RMII0_LINKSTA/LCD_D18/GPT_OPS0_GTOVLO/QSPI0_QIO3/SDHI0_DAT0
  {"P209",&R_PFS->P209PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "VH           " },  //     36   P209  DEBUG_TRACE0_TDATA2/ETH_MII0_EXOUT/ETH_RMII0_EXOUT/LCD_D19/GPT_OPS0_GTOVUP/QSPI0_QIO2/SDHI0_WP
  ...
  {"P301",&R_PFS->P301PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "UL           " },  //     49   P301  AGT0_AGTIO/BUS_A06/LCD_D13/GPT_OPS0_GTOULO/GPT4_GTIOCB/ICU0_IRQ06/SCI2_RXD/SCI2_SCL/SCI9_CTS/SPI1_SSL2
  {"P302",&R_PFS->P302PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "UH           " },  //     48   P302  BUS_A07/LCD_D14/GPT_OPS0_GTOUUP/GPT4_GTIOCA/ICU0_IRQ05/SCI2_SDA/SCI2_TXD/SPI1_SSL3
  ...
  {"P408",&R_PFS->P408PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "WL           " },  //     24   P408  CTSU0_TS04/ETH_MII0_CRS/ETH_RMII0_CRS_DV/GPT_OPS0_GTOWLO/GPT10_GTIOCB/ICU0_IRQ07/IIC0_SCL/PDC0_PIXCLK/SCI3_RXD/SCI3_SCL/USB_FS0_ID/USB_HS0_ID
  {"P409",&R_PFS->P409PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "WH           " },  //     23   P409  CTSU0_TS05/ETH_MII0_RX_CLK/ETH_RMII0_RX_ER/GPT_OPS0_GTOWUP/GPT10_GTIOCA/ICU0_IRQ06/PDC0_HSYNC/SCI3_SDA/SCI3_TXD/USB_FS0_EXICEN/USB_HS0_EXICEN
...
const T_IO_pins_configuration MC50_pins_3ph_PWM_cfg[] =
{
  {"P208",&R_PFS->P208PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "VL           " },  //     37   P208  DEBUG_TRACE0_TDATA3/ETH_MII0_LINKSTA/ETH_RMII0_LINKSTA/LCD_D18/GPT_OPS0_GTOVLO/QSPI0_QIO3/SDHI0_DAT0
  {"P209",&R_PFS->P209PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "VH           " },  //     36   P209  DEBUG_TRACE0_TDATA2/ETH_MII0_EXOUT/ETH_RMII0_EXOUT/LCD_D19/GPT_OPS0_GTOVUP/QSPI0_QIO2/SDHI0_WP
  {"P301",&R_PFS->P301PFS,  PSEL_00 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT__IO ,GP_INP , 0 , "UL           " },  //     49   P301  AGT0_AGTIO/BUS_A06/LCD_D13/GPT_OPS0_GTOULO/GPT4_GTIOCB/ICU0_IRQ06/SCI2_RXD/SCI2_SCL/SCI9_CTS/SPI1_SSL2
  ...
  {"P113",&R_PFS->P113PFS,  PSEL_03 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "GPT2_A       " },  //     56   P113  BUS_A03/LCD_D10/GPT2_GTIOCA/SCI2_RXD/SCI2_SCL/SSI0_SSIWS
  {"P114",&R_PFS->P114PFS,  PSEL_03 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "GPT2_B       " },  //     57   P114  BUS_A02/LCD_D09/GPT2_GTIOCB/SSI0_SSIRXD
  {"P405",&R_PFS->P405PFS,  PSEL_03 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "GPT1_A       " },  //     6    P405  ETH_MII0_TX_EN/ETH_RMII0_TXD_EN/GPT1_GTIOCA/PDC0_PIXD5/SDHI1_DAT5/SSI0_SSITXD
  {"P406",&R_PFS->P406PFS,  PSEL_03 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "GPT1_B       " },  //     7    P406  ETH_MII0_RX_ER/ETH_RMII0_TXD1/GPT1_GTIOCB/PDC0_PIXD4/SDHI1_DAT4/SPI1_SSL3/SSI0_SSIRXD
  {"P414",&R_PFS->P414PFS,  PSEL_03 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "GPT0_B       " },  //     18   P414  CTSU0_TS10/ETH_MII0_RX_ER/ETH_RMII0_TXD1/GPT0_GTIOCB/ICU0_IRQ09/PDC0_PIXD4/SDHI0_WP/SPI0_SSL1
  {"P415",&R_PFS->P415PFS,  PSEL_03 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "GPT0_A       " },  //     17   P415  CTSU0_TS11/ETH_MII0_TX_EN/ETH_RMII0_TXD_EN/GPT0_GTIOCA/ICU0_IRQ08/PDC0_PIXD5/SDHI0_CD/SPI0_SSL2/USB_FS0_VBUSEN
};


const T_IO_pins_configuration MC50_pins_OPS_PWM_cfg[] =
{
  {"P208",&R_PFS->P208PFS,  PSEL_02 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "VL           " },  //     37   P208  DEBUG_TRACE0_TDATA3/ETH_MII0_LINKSTA/ETH_RMII0_LINKSTA/LCD_D18/GPT_OPS0_GTOVLO/QSPI0_QIO3/SDHI0_DAT0
  ...
  {"P301",&R_PFS->P301PFS,  PSEL_02 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "UL           " },  //     49   P301  AGT0_AGTIO/BUS_A06/LCD_D13/GPT_OPS0_GTOULO/GPT4_GTIOCB/ICU0_IRQ06/SCI2_RXD/SCI2_SCL/SCI9_CTS/SPI1_SSL2
  ...
  {"P408",&R_PFS->P408PFS,  PSEL_02 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_OUT , 0 , "WL           " },  //     24   P408  CTSU0_TS04/ETH_MII0_CRS/ETH_RMII0_CRS_DV/GPT_OPS0_GTOWLO/GPT10_GTIOCB/ICU0_IRQ07/IIC0_SCL/PDC0_PIXCLK/SCI3_RXD/SCI3_SCL/USB_FS0_ID/USB_HS0_ID
...
{
  Config_pins(MC50_pins_3ph_PWM_cfg, sizeof(MC50_pins_3ph_PWM_cfg) / sizeof(MC50_pins_3ph_PWM_cfg[0]));
}
...
{
  Config_pins(MC50_pins_OPS_PWM_cfg, sizeof(MC50_pins_OPS_PWM_cfg) / sizeof(MC50_pins_OPS_PWM_cfg[0]));
}
