...
// Model step function
void PIDController_custom(real32_T arg_PID_Input, real32_T arg_SmplTime, PIDParams *arg_Pars, real32_T *arg_PID_Output)
{
  ...
  rtb_Product_Kn = ((arg_PID_Input * arg_Pars->Kd) - arg_Pars->PID_state.Integr2_states) * arg_Pars->Kn;
  ...
  rtb_Sum2 = ((arg_Pars->Kp * arg_PID_Input) + (arg_Pars->PID_state.Integr1_states * arg_SmplTime)) + rtb_Product_Kn;
  ...
  rtb_Integr1Scale = arg_Pars->PID_state.Del2_DSTATE;
  ...
  *arg_PID_Output = rtb_Integr1Scale;
  ...
  arg_Pars->PID_state.Integr1_states = rtb_Sum2 - (-arg_Pars->PID_state.Integr1_states);

  // Update for DiscreteTransferFcn: '<Root>/Integr2'
  arg_Pars->PID_state.Integr2_states = rtb_Product_Kn - (-arg_Pars->PID_state.Integr2_states);
  ...
  arg_Pars->PID_state.Del2_DSTATE = rtb_Integr1Scale;
}
